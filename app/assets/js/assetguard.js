...
class JavaGuard extends EventEmitter {
    ...
    static javaExecFromRoot(rootDir) {
        if (process.platform === 'win32') {
            return path.join(rootDir, 'jre', 'bin', 'javaw.exe')
        } else if (process.platform === 'darwin') {
            return path.join(rootDir, 'Contents', 'Home', 'jre', 'bin', 'java')
        } else if (process.platform === 'linux') {
            return path.join(rootDir, 'jre', 'bin', 'java')
        }
        return rootDir
    }
    ...
    static isJavaExecPath(pth) {
        ...
        if (process.platform === 'win32') {
            return pth.endsWith(path.join('jre', 'bin', 'javaw.exe'))
        } else if (process.platform === 'darwin') {
            return pth.endsWith(path.join('jre', 'bin', 'java'))
        } else if (process.platform === 'linux') {
            return pth.endsWith(path.join('jre', 'bin', 'java'))
        }
        return false
